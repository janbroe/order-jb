...
public class UserRepository {
    ...
    public UserRepository() {
        ...
        createUser(new User().setFirstname("Joske").setLastname("Verboven").setEmail("jvb@hotmail.com").setAddress("Ploplaan 12").setPhoneNumber("0499887766").setPassword("pwd").setRole(Role.CUSTOMER));        createUser(new User().setFirstname("Joske").setLastname("Verboven").setEmail("jvb2@hotmail.com").setAddress("Ploplaan 12").setPhoneNumber("0499887766").setPassword("pwd").setRole(Role.ADMIN));
    }
